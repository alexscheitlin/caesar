...
public class MavenGoalLogParserTest {
    ...
    public void parseGoalLog_MavensurefireTest() {
        ...
        List<Error> expectedErrors = new ArrayList<Error>();
        String path1 = null;
        String file1 = "src/test/java/com/example/bank/BankAccountTest.java";
        int line1 = 21;
        int column1 = 0;
        ...
        expectedErrors.add(expectedError1);
        String path2 = null;
        String file2 = "src/test/java/com/example/bank/BankAccountTest.java";
        int line2 = 49;
        int column2 = 0;
        ...
        expectedErrors.add(expectedError2);
        String path3 = null;
        String file3 = "src/test/java/com/example/bank/TableTest.java";
        int line3 = 26;
        int column3 = 0;
        ...
        String path4 = null;
        String file4 = "src/test/java/com/example/bank/BankAccountTest.java";
        int line4 = 29;
        int column4 = 0;
